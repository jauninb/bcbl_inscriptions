...
public class LicencieMiner {
	...
	private static int FBI_TELEPHONE_CELL_INDEX = indexOfColumn('X');
	private static int FBI_PORTABLE1_CELL_INDEX = indexOfColumn('Y');
	private static int FBI_PORTABLE2_CELL_INDEX = indexOfColumn('Z');
	private static int FBI_EMAIL1_CELL_INDEX = indexOfColumn("AA");
	private static int FBI_EMAIL2_CELL_INDEX = indexOfColumn("AA");
	...
	private static int indexOfColumn(String column) {
		...
		for (int i=column.length()-1; i>=0; i--) {
			...
			//System.out.println("(column.charAt(" + i + ") - 'A')=" + ((int)(column.charAt(i) - 'A')));
			//System.out.println("Math.pow(26, " + puissance + ")=" + Math.pow(26, puissance));
			puissance++;
		}
